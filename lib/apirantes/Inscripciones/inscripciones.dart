...
class Inscripciones extends StatefulWidget {
  ...
  Inscripciones({this.heroTag, this.raceName});
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Inscripciones> {
  ...
  void initState() {
    super.initState();
    ConexionCarreras("Aspirante", "Inscripciones");
  }
              ...
              new ListTile(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => DetailsInscripciones(Data(
